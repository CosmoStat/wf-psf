...
flags.DEFINE_string("id_name", "-coherent_euclid_200stars", "Model saving id.")
# Saving paths
...
flags.DEFINE_list("n_epochs_param", [20, 20], "Number of training epochs of the parametric parts.")
flags.DEFINE_list("n_epochs_non_param", [100, 120], "Number of training epochs of the non-parametric parts.")
