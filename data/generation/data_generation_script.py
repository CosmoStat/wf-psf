...
assert num_train_stars[1] == num_test_stars[0]
assert num_test_stars[1] > num_train_stars[0]
...
if (
    ...
    # Train
    train_positions = np.zeros((num_train_stars[1] - num_train_stars[0], 2))
    train_positions[:, 0] = flat_X[num_train_stars[0] : num_train_stars[1]]
    train_positions[:, 1] = flat_Y[num_train_stars[0] : num_train_stars[1]]
    # Test
    test_positions = np.zeros((num_test_stars[1] - num_test_stars[0], 2))
    test_positions[:, 0] = flat_X[num_test_stars[0] : num_test_stars[1]]
    test_positions[:, 1] = flat_Y[num_test_stars[0] : num_test_stars[1]]
    ...
    train_positions = np.random.rand(num_train_stars[1] - num_train_stars[0], 2)
    test_positions = np.random.rand(num_test_stars[1] - num_test_stars[0], 2)
    ...
    assert num_ref_train_stars <= (num_train_stars[1] - num_train_stars[0])
    assert num_ref_test_stars <= (num_test_stars[1] - num_test_stars[0])

    # Fix to the number of required stars for each dataset
    train_positions = train_positions[: num_train_stars[1] - num_train_stars[0], :]
    test_positions = test_positions[: num_test_stars[1] - num_test_stars[0], :]
...
if plot_option:
    ...
    plt.scatter(
        train_positions[num_train_stars[0] : num_train_stars[1], 0],
        train_positions[num_train_stars[0] : num_train_stars[1], 1],
        s=marker_size,
        label="Train",
    )
    plt.scatter(
        test_positions[num_test_stars[0] : num_test_stars[1], 0],
        test_positions[num_test_stars[0] : num_test_stars[1], 1],
        s=marker_size,
        label="Test",
    )
...
if sims_option == "SFE" or sims_option == "NoSFE":
    ...
    # Train
    train_zks = np.zeros((num_train_stars[1] - num_train_stars[0], max_order))
    train_zks[:, :] = flat_rZ_cube[num_train_stars[0] : num_train_stars[1], :]
    # Test
    test_zks = np.zeros((num_test_stars[1] - num_test_stars[0], max_order))
    test_zks[:, :] = flat_rZ_cube[num_test_stars[0] : num_test_stars[1], :]
...
total_n_stars = (num_train_stars[1] - num_train_stars[0]) + (
    num_test_stars[1] - num_test_stars[0]
)

train_n_stars = num_train_stars[1] - num_train_stars[0]
test_n_stars = num_test_stars[1] - num_test_stars[0]

# Select random SEDs for train dataset
train_SED_list = []
for it in range(train_n_stars):
...
if add_intrapixel_shifts:
    ...
    train_delta_centroid_shifts = delta_centroid_shifts[
        num_train_stars[0] : num_train_stars[1], :
    ]
    test_delta_centroid_shifts = delta_centroid_shifts[
        num_test_stars[0] : num_test_stars[1], :
    ]
    # Extract the delta_pix for train and test datasets
    train_delta_pix_x = delta_pix_x[num_train_stars[0] : num_train_stars[1], :]
    train_delta_pix_y = delta_pix_y[num_train_stars[0] : num_train_stars[1], :]
    test_delta_pix_x = delta_pix_x[num_test_stars[0] : num_test_stars[1], :]
    test_delta_pix_y = delta_pix_y[num_test_stars[0] : num_test_stars[1], :]
...
if plot_option:
    it = 0
    wfe_example = np.einsum("ijk,ijk->jk", zernikes, train_zks[it, :].reshape(-1, 1, 1))
    wfe_rms = np.sqrt(
...
n_train_stars = num_train_stars[1] - num_train_stars[0]
...
if sims_option != "SFE" and sims_option != "NoSFE":
    ...
    for it in range(len(error_field_desired_wfe_rms)):
        ...
        train_dataset_params["error_field_req_wfe_rms"] = error_field_req_wfe_rms[it]
