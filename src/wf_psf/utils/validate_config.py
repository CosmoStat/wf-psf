...
class ValidateConfig:
    ...
    def check_if_equals_name(self, *conf_params):
        """Check Config Param Equals Name.
        ...
        try:
            for condition in conditions["function"]:
                ...
                if condition_type[condition](config_param, conditions["name"]) is True:
                    print("{} fulfills condition {}".format(config_param, condition))
                    print(" ")
                    break
                else:
                    print(
            ...
            logger.exception("Config Param does not fulfill condition.")
