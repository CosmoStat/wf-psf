"""Validate Training Config Dict.

A module containing a dictionary of the training
configuration parameters as keys and as values the
functions to be applied to validate the corresponding
parameter.
