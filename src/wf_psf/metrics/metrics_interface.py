...
class MetricsParamsHandler:
    ...
    def evaluate_metrics_chi2(
        ...
        return {
            ...
            "mean_reduced_chi2_stat_per_image": mean_reduced_chi2_stat_per_image,
            "median_reduced_chi2_stat_per_image": median_reduced_chi2_stat_per_image,
            "std_reduced_chi2_stat_per_image": std_reduced_chi2_stat_per_image,
            "mean_noise_std_dev": mean_noise_std_dev,
            "estimated_noise_std_dev": estimated_noise_std_dev,
        }
