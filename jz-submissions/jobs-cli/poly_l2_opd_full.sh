...
opt[2]="--id_name poly_l2_opd_2k_ --train_dataset_file train_Euclid_res_2000_TrainStars_id_001.np  --n_epochs_param 20 20 --n_epochs_non_param 150 100 --l_rate_param 0.01 0.001 --l_rate_non_param 0.1 0.01"
